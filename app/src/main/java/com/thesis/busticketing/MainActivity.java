...
import com.thesis.busticketing.ui.HomeFragment;
import com.thesis.busticketing.ui.OffersFragment;
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch(item.getItemId()){
            ...
            case R.id.Bus_Information:
                Intent iintent = new Intent(MainActivity.this, BusInformationActivity.class);
